...
/**
 * A component within a DirectedNeuralNetwork where data flows in a left-to-right direction
 ...
 * @param <A> The type of DirectedComponentActivation produced by this component.
 * @param <C> The type of context used by this component for forward propagation, and by the
 * resulting activation for back propagation.
 * 		
 */
public interface DirectedComponent<I, A extends DirectedComponentActivation<I, ?>, C>
	 ...
	 * @return A DirectedComponentActivation encapsulating the artifacts generated by
	 *         this forward propagation - including the output from the right hand side of this 
	 *         DirectedComponent.
	 */
