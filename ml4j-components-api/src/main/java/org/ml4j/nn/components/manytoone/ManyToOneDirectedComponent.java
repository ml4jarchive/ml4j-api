...
public interface ManyToOneDirectedComponent<A extends ManyToOneDirectedComponentActivation>
		extends DirectedComponent<List<NeuronsActivation>, A, DirectedComponentsContext, DirectedComponentFactory>, NeuronsActivationComponent {

	@Override
	ManyToOneDirectedComponent<A> dup(DirectedComponentFactory directedComponentFactory);
}
