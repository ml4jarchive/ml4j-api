...
public interface Axons3DGraphBuilder<C extends Axons3DBuilder<T>, A extends AxonsBuilder<T>, T extends NeuralComponent> extends Axons3DPermitted<C, A, T>, Axons3DBuilder<T>, ParallelPathsPermitted<Axons3DSubGraphBuilder<C, A, T>>, SkipConnection3DPermitted<Axons3DGraphSkipConnectionBuilder<C, A, T>, T>{
