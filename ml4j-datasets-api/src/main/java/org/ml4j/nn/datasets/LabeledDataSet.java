...
/**
 * Encapsulates a DataSet of LabeledData elements containing elements and labels
 * of a defined type
 * 
 * @author Michael Lavelle
 *
 * @param <E> The type of element within each LabeledData instance with this
 *            DataSet
 * @param <L> The type of label within each LabeledData instance with this
 *            DataSet
 */
public interface LabeledDataSet<E, L> extends Streamable<LabeledData<E, L>> {
	...
	/**
	 * Convert to a BatchedLabeledDataSet, with each batch containing at most
	 * batchSize elements with their labels.
	 * 
	 * @param batchSize The maximum size of each batch in the returned
	 *                  BatchedLabeledDataSet.
	 * @return A BatchedLabeledDataSet.
	 */
	BatchedLabeledDataSet<E, L> toBatchedLabeledDataSet(int batchSize);

	/**
	 * Convert to a FloatArrayLabeledDataSet, using the specified featureExtractor
	 ...
	 */
	FloatArrayLabeledDataSet toFloatArrayLabeledDataSet(FeatureExtractor<E> featureExtractor,
