...
/**
 *
 * Encapsulates a function to create an output ActivationFunctionActivation from
 * an input NeuronsActivation - typically applied to the output of Axons to
 * introduce non linearities.
 * 
 * @author Michael Lavelle
 *
 * @param <F> The specific class of this ActivationFunction.
 * @param <G> The specific class of ActivationFunctionActivation produced on
 *            activation.
 */
public interface ActivationFunction<F extends ActivationFunction<F, G>, G extends ActivationFunctionActivation<F, G>>
