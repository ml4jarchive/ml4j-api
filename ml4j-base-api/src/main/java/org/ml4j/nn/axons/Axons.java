 ...
 */
public interface Axons<L extends Neurons, R extends Neurons, A extends Axons<L, R, A>> extends Serializable {
	 ...
	 * 
	 * @param leftNeuronsActivation         The activation applied to the left hand
	 *                                      side of these Axons
	 * @param previousRightToLeftActivation If this push from left to right depends
	 *                                      on a previous push from right to left,
	 *                                      the previous right-to-left activation
	 *                                      should be provided as an input here. It
	 *                                      is up to concrete implementations of
	 *                                      Axons to determine whether this input is
	 *                                      required or not and to validate this is
	 *                                      present - if not required this input can
	 *                                      be left as null.
	 * 
	 ...
	 * 
	 * @param rightNeuronsActivation        The activation applied to the left hand
	 *                                      side of these Axons
	 * @param previousLeftToRightActivation If this push from right to left depends
	 *                                      on a previous push from left to right,
	 *                                      the previous left-to-right activation
	 *                                      should be provided as an input here. It
	 *                                      is up to concrete implementations of
	 *                                      Axons to determine whether this input is
	 *                                      required or not and to validate this is
